...
// Función para mostrar la ventana modal al inicio del juego
function mostrarModal() {
    ...
    btnIniciarJuego.addEventListener("click", () => {
        ocultarModal();
        iniciarJuego(); // Llamar función para iniciar el juego principal
    });
    ...
    modal.style.display = "flex"; // Mostrar modal al inicio
}
